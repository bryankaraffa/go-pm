...
// TestAutoDetectFromSubdirectory tests the full work item lifecycle when running
// from a subdirectory of the repository root, ensuring auto-detection works correctly
